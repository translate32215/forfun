...
public final class v2 {
    ...
    public static final String[] f12680c = {"/dev/socket/genyd", "/dev/socket/baseband_genyd"};

    /* renamed from: d  reason: collision with root package name */
    public static final String[] f12681d = {"goldfish"};

    /* renamed from: e  reason: collision with root package name */
    public static final String[] f12682e = {"/dev/socket/qemud", "/dev/qemu_pipe"};

    /* renamed from: f  reason: collision with root package name */
    public static final String[] f12683f = {"ueventd.android_x86.rc", "x86.prop", "ueventd.ttVM_x86.rc", "init.ttVM_x86.rc", "fstab.ttVM_x86", "fstab.vbox86", "init.vbox86.rc", "ueventd.vbox86.rc"};

    /* renamed from: g  reason: collision with root package name */
    public static final String[] f12684g = {"fstab.andy", "ueventd.andy.rc"};

    /* renamed from: h  reason: collision with root package name */
    public static final String[] f12685h = {"fstab.nox", "init.nox.rc", "ueventd.nox.rc", "/BigNoxGameHD", "/YSLauncher"};

    /* renamed from: i  reason: collision with root package name */
    public static final h8[] f12686i = {new h8("init.svc.qemud", (String) null), new h8("init.svc.qemu-props", (String) null), new h8("qemu.hw.mainkeys", (String) null), new h8("qemu.sf.fake_camera", (String) null), new h8("qemu.sf.lcd_density", (String) null), new h8("ro.bootloader", "unknown"), new h8("ro.bootmode", "unknown"), new h8("ro.hardware", "goldfish"), new h8("ro.kernel.android.qemud", (String) null), new h8("ro.kernel.qemu.gles", (String) null), new h8("ro.kernel.qemu", "1"), new h8("ro.product.device", "generic"), new h8("ro.product.model", "sdk"), new h8("ro.product.name", "sdk"), new h8("ro.serialno", (String) null), new h8("ro.build.description", "72656C656173652D6B657973"), new h8("ro.build.fingerprint", "3A757365722F72656C656173652D6B657973"), new h8("net.eth0.dns1", (String) null), new h8("rild.libpath", "2F73797374656D2F6C69622F6C69627265666572656E63652D72696C2E736F"), new h8("ro.radio.use-ppp", (String) null), new h8("gsm.version.baseband", (String) null), new h8("ro.build.tags", "72656C656173652D6B65"), new h8("ro.build.display.id", "746573742D"), new h8("init.svc.console", (String) null)};
    @SuppressLint({"StaticFieldLeak"})

    /* renamed from: j  reason: collision with root package name */
    public static v2 f12687j;

    /* renamed from: k  reason: collision with root package name */
    public static Boolean f12688k;

    /* renamed from: a  reason: collision with root package name */
    public final Context f12689a;

    /* renamed from: b  reason: collision with root package name */
    public List<String> f12690b;
    ...
    public v2(Context context) {
        ...
        this.f12690b.add("com.bluestacks");
        this.f12690b.add("com.bignox.app");
        this.f12690b.add("com.vphone.launcher");
    }

    public final boolean a(String[] strArr, String str) {
        File file;
        for (String str2 : strArr) {
            if (!a(this.f12689a, "android.permission.READ_EXTERNAL_STORAGE") || !str2.contains("/") || !str.equals("Nox")) {
                file = new File(str2);
            } else {
    ...
    public final boolean b() {
        ...
        L_0x007b:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.v2.b():boolean");
    }
    ...
    public final boolean c() {
        ...
        L_0x0137:
            ...
            r6 = r0[r2]
            android.content.Context r7 = r12.f12689a
            java.lang.String r8 = r6.f10502a
        ...
        L_0x0160:
            r7 = 0
        L_0x0161:
            java.lang.String r6 = r6.f10503b
        ...
        L_0x018e:
            ...
            java.util.List<java.lang.String> r0 = r12.f12690b
            boolean r0 = r0.isEmpty()
            if (r0 == 0) goto L_0x0199
            goto L_0x01c6
        L_0x0199:
            android.content.Context r0 = r12.f12689a
            android.content.pm.PackageManager r0 = r0.getPackageManager()
            java.util.List<java.lang.String> r1 = r12.f12690b
        ...
        L_0x01c6:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.v2.c():boolean");
    }

    public final boolean a() {
        if (!a(this.f12689a, "android.permission.INTERNET")) {
            return false;
        }
