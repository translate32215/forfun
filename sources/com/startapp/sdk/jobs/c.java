...
public class c implements k9 {
    ...
    public final JobScheduler f12564a;

    /* renamed from: b  reason: collision with root package name */
    public final ComponentName f12565b;
    ...
    public c(Context context, Class<? extends JobService> cls) throws IllegalStateException {
        ...
        if (jobScheduler != null) {
            this.f12564a = jobScheduler;
            this.f12565b = new ComponentName(context, cls);
            this.f12566c = a0.a(context, "android.permission.RECEIVE_BOOT_COMPLETED");
            return;
        }
    ...
    public final JobInfo.Builder a(JobRequest jobRequest, Integer num) {
        ...
        if (num != null) {
            ...
            i10 = JobRequest.a(jobRequest.f12549a);
        }
        JobInfo.Builder builder = new JobInfo.Builder(i10, this.f12565b);
        PersistableBundle persistableBundle = new PersistableBundle();
        persistableBundle.putString("extraKeyUuid", jobRequest.f12550b.toString());
        persistableBundle.putStringArray("extraKeyTags", jobRequest.f12549a);
        if (num != null) {
            persistableBundle.putInt("extraKeyDuplicate", 1);
        }
        builder.setExtras(persistableBundle);
        JobRequest.Network network = jobRequest.f12551c;
        if (network != null) {
    ...
    public final boolean a(JobInfo jobInfo) {
        try {
            return this.f12564a.schedule(jobInfo) == 1;
    ...
    public final List<JobInfo> a() {
        List<JobInfo> list;
        try {
            list = this.f12564a.getAllPendingJobs();
        ...
        for (JobInfo next : list) {
            if (this.f12565b.equals(next.getService())) {
                arrayList.add(next);
            }
        }
        return arrayList;
    ...
    public boolean a(JobRequest jobRequest, long j10) {
        ...
        for (JobInfo next : a11) {
            if (next.getId() == JobRequest.a(jobRequest.f12549a) && next.getIntervalMillis() == j10) {
                return false;
            }
        }
    ...
    public boolean a(JobRequest jobRequest, Long l10, Long l11) {
        ...
        if (Build.VERSION.SDK_INT == 23) {
            String uuid = jobRequest.f12550b.toString();
            List<JobInfo> a12 = a();
            if (a12 != null) {
