...
public class z2 {
    ...
    public class a implements Runnable {
        ...
        public final /* synthetic */ Serializable f12910c;

        public a(Context context, String str, Serializable serializable) {
            this.f12908a = context;
            this.f12909b = str;
            this.f12910c = serializable;
        }

        public void run() {
            Context context = this.f12908a;
            String str = this.f12909b;
            Serializable serializable = this.f12910c;
            if (str != null) {
                try {
                    z2.a(z2.c(context, (String) null), str, serializable);
                } catch (Throwable th) {
                    if (z2.a(4)) {
                        i4.a(th);
                    }
    ...
    public static String c(Context context, String str) {
        ...
        sb2.append(str != null ? e.a(new StringBuilder(), File.separator, str) : "");
        return sb2.toString();
    }
