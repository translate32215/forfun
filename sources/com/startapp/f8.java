...
public class f8 {
    ...
    public static volatile l8 f10382a;
    ...
    public static final class a implements ServiceConnection {
        ...
        public final CountDownLatch f10384b;

        public a(String str, CountDownLatch countDownLatch) {
            this.f10383a = str;
            this.f10384b = countDownLatch;
        }

        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            c4 c4Var;
            try {
                int i10 = c4.a.f10235a;
                if (iBinder == null) {
                    c4Var = null;
                } else {
                    IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.finsky.externalreferrer.IGetInstallReferrerService");
                    if (queryLocalInterface == null || !(queryLocalInterface instanceof c4)) {
                        c4Var = new c4.a.C0113a(iBinder);
                    } else {
                        c4Var = (c4) queryLocalInterface;
                    }
                }
                Bundle bundle = new Bundle();
                bundle.putString("package_name", this.f10383a);
                f8.f10382a = new l8(c4Var.a(bundle));
            } catch (Throwable unused) {
            }
            this.f10384b.countDown();
        }
    ...
    public static com.startapp.l8 a(android.content.Context r6) {
        /*
            java.lang.String r0 = "com.android.vending"
            com.startapp.l8 r1 = f10382a
        ...
        L_0x0053:
            ...
            com.startapp.f8$a r2 = new com.startapp.f8$a     // Catch:{ SecurityException -> 0x007d, all -> 0x0079 }
        ...
        L_0x007d:
            com.startapp.l8 r6 = f10382a
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.f8.a(android.content.Context):com.startapp.l8");
    }
}
