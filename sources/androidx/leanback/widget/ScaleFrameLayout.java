...
public class ScaleFrameLayout extends FrameLayout {
    ...
    public float f2196a = 1.0f;

    /* renamed from: b  reason: collision with root package name */
    public float f2197b = 1.0f;

    /* renamed from: c  reason: collision with root package name */
    public float f2198c = 1.0f;
    ...
    public static int a(int i10, float f10) {
        return f10 == 1.0f ? i10 : View.MeasureSpec.makeMeasureSpec((int) ((((float) View.MeasureSpec.getSize(i10)) / f10) + 0.5f), View.MeasureSpec.getMode(i10));
    }

    public void addView(View view, int i10, ViewGroup.LayoutParams layoutParams) {
        super.addView(view, i10, layoutParams);
        view.setScaleX(this.f2198c);
        view.setScaleY(this.f2198c);
    }
    ...
    public void onMeasure(int i10, int i11) {
        float f10 = this.f2196a;
        if (f10 == 1.0f && this.f2197b == 1.0f) {
            super.onMeasure(i10, i11);
            return;
        }
        super.onMeasure(a(i10, f10), a(i11, this.f2197b));
        setMeasuredDimension((int) ((((float) getMeasuredWidth()) * this.f2196a) + 0.5f), (int) ((((float) getMeasuredHeight()) * this.f2197b) + 0.5f));
    }
