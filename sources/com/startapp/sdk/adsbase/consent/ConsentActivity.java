...
public class ConsentActivity extends Activity {
    ...
    public void onBackPressed() {
        ...
        if (str != null && url != null && url.contains(str)) {
            this.f12305a.loadUrl("javascript:startappBackPressed();");
        } else if (this.f12305a.canGoBack()) {
            this.f12305a.goBack();
        } else {
            this.f12307c = true;
            super.onBackPressed();
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (!TextUtils.isEmpty(dataString)) {
            try {
                ...
                this.f12306b = new URI(uri.getScheme(), uri.getAuthority(), uri.getPath(), (String) null, (String) null).toString();
                WebView b10 = ComponentLocator.a((Context) this).w().b();
                this.f12305a = b10;
                b10.setWebViewClient(new a());
                this.f12305a.getSettings().setJavaScriptEnabled(true);
                this.f12305a.setHorizontalScrollBarEnabled(false);
                this.f12305a.setVerticalScrollBarEnabled(false);
                this.f12305a.getSettings().setTextZoom(100);
                this.f12305a.loadUrl(dataString);
                this.f12305a.setBackgroundColor(0);
                a0.a(this.f12305a, (Paint) null);
                RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams2.addRule(13);
                relativeLayout.addView(this.f12305a, layoutParams2);
            } catch (Throwable th) {
                i4.a(th);
            }
        }
    ...
    public void onStop() {
        ...
        if (!this.f12307c && m10 != null && m10.j() && wb.g(this) && wb.e((Context) this)) {
            i4 i4Var = new i4(j4.f10587d);
            i4Var.f10537d = "ConsentActivityHasBeenCovered";
            i4Var.a();
            finish();
            try {
        ...
        e2 f10 = ComponentLocator.a((Context) this).f();
        f10.f10320d = false;
        Intent intent = f10.f10319c;
        if (intent != null) {
            try {
                f10.f10317a.startActivity(intent);
            } catch (Throwable th2) {
                i4.a(th2);
            }
        }
    ...
    public class a extends WebViewClient {
        ...
        public final boolean a(android.net.Uri r12) {
            /*
                ...
                com.startapp.sdk.adsbase.consent.ConsentConfig r2 = r2.m()
                r3 = 0
        ...
        public void onPageFinished(android.webkit.WebView r8, java.lang.String r9) {
            ...
            L_0x0040:
                ...
                java.util.Map<android.app.Activity, java.lang.Integer> r2 = com.startapp.wb.f12765a
            ...
            L_0x005c:
                ...
                java.lang.String r9 = com.startapp.wb.a((android.graphics.drawable.Drawable) r2, (int) r5, (int) r5, (android.graphics.Bitmap.Config) r6)     // Catch:{ OutOfMemoryError -> 0x0072 }
                goto L_0x0083
            L_0x0072:
                ...
                java.lang.String r9 = com.startapp.wb.a((android.graphics.drawable.Drawable) r2, (int) r9, (int) r9, (android.graphics.Bitmap.Config) r5)     // Catch:{ OutOfMemoryError -> 0x0082 }
                goto L_0x0083
            L_0x007e:
                r9 = move-exception
                com.startapp.i4.a((java.lang.Throwable) r9)
            L_0x0082:
                r9 = 0
            L_0x0083:
                boolean r2 = android.text.TextUtils.isEmpty(r9)
            ...
            L_0x00eb:
                ...
                com.startapp.c6 r9 = r9.n()
                java.lang.Object r9 = r9.b()
                com.startapp.b6 r9 = (com.startapp.b6) r9
                java.lang.String r9 = r9.f10139c
                boolean r2 = android.text.TextUtils.isEmpty(r9)
