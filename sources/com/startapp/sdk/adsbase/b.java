...
public abstract class b {
    ...
    public final Ad f12232b;

    /* renamed from: c  reason: collision with root package name */
    public final AdPreferences f12233c;

    /* renamed from: d  reason: collision with root package name */
    public AdEventListener f12234d;

    /* renamed from: e  reason: collision with root package name */
    public AdPreferences.Placement f12235e;

    /* renamed from: f  reason: collision with root package name */
    public String f12236f = null;
    ...
    public b(Context context, Ad ad2, AdPreferences adPreferences, AdEventListener adEventListener, AdPreferences.Placement placement) {
        ...
        this.f12232b = ad2;
        this.f12233c = adPreferences;
        this.f12234d = adEventListener;
        this.f12235e = placement;
    }

    public AdEventListener a() {
        AdEventListener adEventListener = this.f12234d;
        this.f12234d = null;
    ...
    public void c() {
        try {
            ComponentLocator.a(this.f12231a).p().execute(new a());
            return;
        } catch (Throwable th) {
            i4.a(th);
        }
    ...
    public com.startapp.sdk.adsbase.model.GetAdRequest a(com.startapp.sdk.adsbase.model.GetAdRequest r11) {
        /*
            ...
            com.startapp.sdk.adsbase.SimpleTokenUtils$TokenType r1 = com.startapp.sdk.adsbase.SimpleTokenUtils.f12119h     // Catch:{ all -> 0x0078 }
            ...
            boolean r1 = com.startapp.sdk.adsbase.SimpleTokenUtils.f12117f     // Catch:{ all -> 0x0078 }
            boolean r6 = com.startapp.sdk.adsbase.SimpleTokenUtils.f12118g     // Catch:{ all -> 0x0078 }
        ...
        L_0x0040:
            ...
            goto L_0x004a
        L_0x0043:
            boolean r1 = com.startapp.sdk.adsbase.SimpleTokenUtils.f12118g     // Catch:{ all -> 0x0078 }
        ...
        L_0x0049:
            r1 = 0
        L_0x004a:
            com.startapp.sdk.adsbase.SimpleTokenUtils.f12118g = r1     // Catch:{ all -> 0x0078 }
        ...
        L_0x004f:
            ...
            com.startapp.sdk.adsbase.e r0 = r0.d()     // Catch:{ all -> 0x0078 }
        ...
        L_0x0078:
            r0 = move-exception
            com.startapp.i4.a((java.lang.Throwable) r0)     // Catch:{ all -> 0x00fe }
        L_0x007c:
            ...
            monitor-exit(r4)
            android.content.Context r1 = r10.f12231a     // Catch:{ all -> 0x00ee }
            com.startapp.sdk.adsbase.model.AdPreferences r2 = r10.f12233c     // Catch:{ all -> 0x00ee }
            com.startapp.sdk.adsbase.model.AdPreferences$Placement r3 = r10.f12235e     // Catch:{ all -> 0x00ee }
            r11.a(r1, r2, r3, r0)     // Catch:{ all -> 0x00ee }
            android.content.Context r1 = r10.f12231a     // Catch:{ all -> 0x00ee }
            r11.g(r1)     // Catch:{ all -> 0x00ee }
            com.startapp.sdk.adsbase.AdsCommonMetaData r1 = com.startapp.sdk.adsbase.AdsCommonMetaData.f12098h     // Catch:{ all -> 0x00ee }
            boolean r1 = r1.M()     // Catch:{ all -> 0x00ee }
            if (r1 != 0) goto L_0x00ae
            android.content.Context r1 = r10.f12231a     // Catch:{ all -> 0x00ee }
            com.startapp.sdk.adsbase.model.AdPreferences$Placement r2 = r10.f12235e     // Catch:{ all -> 0x00ee }
            ...
            if (r1 == 0) goto L_0x00ae
            r11.f12362s0 = r8     // Catch:{ all -> 0x00ee }
        L_0x00ae:
            android.content.Context r0 = r10.f12231a     // Catch:{ all -> 0x00b6 }
            com.startapp.sdk.adsbase.model.AdPreferences r1 = r10.f12233c     // Catch:{ all -> 0x00b6 }
        ...
        L_0x00ba:
            android.content.Context r0 = r10.f12231a     // Catch:{ all -> 0x00e9 }
            ...
            com.startapp.i6 r0 = r0.o()     // Catch:{ all -> 0x00e9 }
        ...
        L_0x00ee:
            r11 = move-exception
            com.startapp.i4.a((java.lang.Throwable) r11)
            F r11 = r0.first
            ...
            com.startapp.sdk.adsbase.SimpleTokenUtils.f12119h = r11
            r11 = 0
            return r11
        L_0x00fe:
            r11 = move-exception
