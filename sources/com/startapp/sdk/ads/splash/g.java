...
public class g {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f11936a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f11936a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f11936a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f11936a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f11936a     // Catch:{ NoSuchFieldError -> 0x0049 }
    ...
    public static View a(Context context, SplashConfig splashConfig) {
        ...
        Point point = new Point(l0.a(context2, 1, (float) 150), l0.a(context2, 1, (float) 28));
        if (splashConfig.getOrientation() == SplashConfig.Orientation.PORTRAIT) {
            i13 = l0.a(context2, 1, (float) 5);
            i12 = l0.a(context2, 1, (float) 8);
            i11 = l0.a(context2, 1, (float) 75);
            i10 = l0.a(context2, 1, (float) 130);
        } else {
            i13 = l0.a(context2, 1, (float) 5);
            i12 = l0.a(context2, 1, (float) 8);
            i11 = l0.a(context2, 1, (float) 40);
            i10 = l0.a(context2, 1, (float) 100);
        }
