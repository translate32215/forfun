...
public class AdInformationConfig implements Serializable {
    ...
    public static final String f12181b = "https://funnel-assets.startappservice.com/consent/index.html";
    private static final long serialVersionUID = 8911501868319500986L;
    @ob(type = ArrayList.class, value = ImageResourceConfig.class)
    private List<ImageResourceConfig> ImageResources = new ArrayList();
    @ob(key = AdPreferences.Placement.class, type = HashMap.class, value = AdInformationPositions.Position.class)
    public HashMap<AdPreferences.Placement, AdInformationPositions.Position> Positions = new HashMap<>();

    /* renamed from: a  reason: collision with root package name */
    public transient EnumMap<ImageResourceType, ImageResourceConfig> f12182a = new EnumMap<>(ImageResourceType.class);
    private Integer consentTypeInfo;
    private String dialogUrlSecured = f12181b;
    ...
    public boolean equals(Object obj) {
        ...
        if (this.enabled != adInformationConfig.enabled || Float.compare(adInformationConfig.fatFingersFactor, this.fatFingersFactor) != 0 || !wb.a(this.consentTypeInfo, adInformationConfig.consentTypeInfo) || !wb.a(this.dialogUrlSecured, adInformationConfig.dialogUrlSecured) || !wb.a(this.eulaUrlSecured, adInformationConfig.eulaUrlSecured) || !wb.a(this.Positions, adInformationConfig.Positions) || !wb.a(this.ImageResources, adInformationConfig.ImageResources)) {
            return false;
        }
        return true;
    }
    ...
    public static void a(AdInformationConfig adInformationConfig) {
        ...
        for (ImageResourceType imageResourceType : ImageResourceType.values()) {
            ImageResourceConfig imageResourceConfig = adInformationConfig.f12182a.get(imageResourceType);
            if (imageResourceConfig == null) {
                ...
                adInformationConfig.f12182a.put(imageResourceType, imageResourceConfig);
                if (z10) {
        ...
        while (i10 < length) {
            ...
            if (adInformationConfig.f12182a.get(imageResourceType2) != null) {
                i10++;
            } else {
    ...
    public void a(Context context) {
        for (ImageResourceConfig next : this.ImageResources) {
            this.f12182a.put(ImageResourceType.getByName(next.c()), next);
            next.f12202a = null;
            new f1(context, next.b(), new f4(next), 0).a();
        }
    }
}
