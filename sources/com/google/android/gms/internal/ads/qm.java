...
public final /* synthetic */ class qm {
    ...
    static {
        ...
        L_0x000d:
            r0 = 2
            r3 = 4
            int[] r4 = f7981a     // Catch:{ NoSuchFieldError -> 0x0013 }
            r4[r3] = r0     // Catch:{ NoSuchFieldError -> 0x0013 }
        L_0x0013:
            int[] r4 = f7981a     // Catch:{ NoSuchFieldError -> 0x0017 }
            r4[r0] = r2     // Catch:{ NoSuchFieldError -> 0x0017 }
        L_0x0017:
            r0 = 5
            int[] r2 = f7981a     // Catch:{ NoSuchFieldError -> 0x001c }
            r2[r0] = r3     // Catch:{ NoSuchFieldError -> 0x001c }
        L_0x001c:
            r2 = 6
            int[] r3 = f7981a     // Catch:{ NoSuchFieldError -> 0x0021 }
            r3[r2] = r0     // Catch:{ NoSuchFieldError -> 0x0021 }
        L_0x0021:
            int[] r0 = f7981a     // Catch:{ NoSuchFieldError -> 0x0026 }
            r3 = 0
            r0[r3] = r2     // Catch:{ NoSuchFieldError -> 0x0026 }
        L_0x0026:
            int[] r0 = f7981a     // Catch:{ NoSuchFieldError -> 0x002b }
            r2 = 7
