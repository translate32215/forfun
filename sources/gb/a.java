...
public class a {
    ...
    public static final TimeZone f18614a = TimeZone.getTimeZone("UTC");
    ...
    public static java.util.Date b(java.lang.String r17, java.text.ParsePosition r18) throws java.text.ParseException {
        ...
        L_0x00db:
            ...
            java.util.TimeZone r9 = f18614a     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            int r4 = r4 + r8
            goto L_0x0197
        L_0x00ed:
    ...
    public static int c(String str, int i10, int i11) throws NumberFormatException {
        ...
        if (i10 < i11) {
            ...
            if (digit >= 0) {
                ...
                StringBuilder a10 = android.support.v4.media.a.a("Invalid number: ");
        ...
        while (i13 < i11) {
            ...
            if (digit2 >= 0) {
                ...
                StringBuilder a11 = android.support.v4.media.a.a("Invalid number: ");
