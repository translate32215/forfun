...
public class VideoUtil {
    ...
    public static void a(Context context, qc qcVar) {
        if (context != null && qcVar != null) {
            for (String next : qcVar.f11631a) {
                if (next != null && next.length() > 0) {
                    bb.a(context, next, (c3<String, o7.a, Throwable, Void>) null);
                }
            }
        }
    }
    ...
    public static void b(Context context) {
        ...
        a10.f12335a.putInt("videoErrorsCount", i11);
        a10.apply();
    }
    ...
    public static VideoEligibility a(Context context) {
        ...
        boolean z10 = true;
        if (AdsCommonMetaData.f12098h.G().o() >= 0 && ComponentLocator.a(context).d().getInt("videoErrorsCount", 0) >= AdsCommonMetaData.f12098h.G().o()) {
            videoEligibility = VideoEligibility.INELIGIBLE_ERRORS_THRESHOLD_REACHED;
        }
        if (!wb.a(context, (Class<? extends Activity>) OverlayActivity.class)) {
        ...
        if (j10 < 0 || j10 / 1024 <= AdsCommonMetaData.f12098h.G().f() * 1024) {
            z10 = false;
        }
