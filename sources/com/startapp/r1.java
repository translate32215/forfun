...
public class r1 {
    ...
    public final Class[] f11641d;

    /* renamed from: e  reason: collision with root package name */
    public final Object[] f11642e;

    /* renamed from: f  reason: collision with root package name */
    public final String[] f11643f;

    /* renamed from: g  reason: collision with root package name */
    public transient SoftReference<t1> f11644g;

    /* renamed from: h  reason: collision with root package name */
    public final transient Map<String, SoftReference<Map<String, Object>>> f11645h = new ConcurrentHashMap();
    ...
    public static class a implements Iterator<Object> {
        ...
        public boolean hasNext() {
            return this.f11648c < this.f11647b;
        }
    ...
    public org.json.JSONArray a(android.content.Context r9, int[] r10, java.lang.Integer r11) {
        /*
            r8 = this;
            r0 = 5
            com.startapp.t1 r9 = r8.a((android.content.Context) r9)     // Catch:{ InvocationTargetException -> 0x015b, IllegalAccessException -> 0x0150 }
            java.lang.Object[] r1 = r8.f11642e     // Catch:{ InvocationTargetException -> 0x015b, IllegalAccessException -> 0x0150 }
            java.lang.reflect.Method r2 = r9.f12602b     // Catch:{ InvocationTargetException -> 0x015b, IllegalAccessException -> 0x0150 }
            java.lang.Object r9 = r9.f12601a     // Catch:{ InvocationTargetException -> 0x015b, IllegalAccessException -> 0x0150 }
            java.lang.Object r9 = r2.invoke(r9, r1)     // Catch:{ InvocationTargetException -> 0x015b, IllegalAccessException -> 0x0150 }
            if (r9 != 0) goto L_0x0014
            com.startapp.r1$b r9 = com.startapp.r1.b.f11649a
            goto L_0x003c
        L_0x0014:
        ...
        L_0x001f:
            ...
            com.startapp.r1$a r0 = new com.startapp.r1$a
        ...
        L_0x0050:
            ...
            java.util.Map<java.lang.String, java.lang.ref.SoftReference<java.util.Map<java.lang.String, java.lang.Object>>> r6 = r8.f11645h
        ...
        L_0x006d:
            ...
            java.lang.String[] r2 = r8.f11643f
        ...
        L_0x00e1:
            ...
            java.lang.String[] r9 = r8.f11643f
            int r9 = r9.length
            int r1 = r10.length
            r4 = 0
        L_0x00eb:
            ...
            java.lang.String[] r6 = r8.f11643f
        ...
        L_0x0167:
            goto L_0x0166
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.r1.a(android.content.Context, int[], java.lang.Integer):org.json.JSONArray");
    }
    ...
    public boolean equals(Object obj) {
        ...
        r1 r1Var = (r1) obj;
        if (!wb.a(this.f11638a, r1Var.f11638a) || !wb.a(this.f11639b, r1Var.f11639b) || !Arrays.equals(this.f11640c, r1Var.f11640c) || !Arrays.equals(this.f11642e, r1Var.f11642e) || !Arrays.equals(this.f11643f, r1Var.f11643f)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        Object[] objArr = {this.f11638a, this.f11639b, this.f11640c, this.f11642e, this.f11643f};
    ...
    public final t1 a(Context context) {
        Object obj;
        SoftReference<t1> softReference = this.f11644g;
        t1 t1Var = softReference != null ? softReference.get() : null;
        if (t1Var != null) {
            return t1Var;
        }
        Object systemService = context.getSystemService(this.f11638a);
        if (systemService == null) {
            try {
                Object obj2 = ((LinkedHashMap) a(Context.class, new String[]{this.f11638a})).get(this.f11638a);
        ...
        if (systemService != null) {
            try {
                Method a10 = a(systemService.getClass(), this.f11639b, this.f11641d);
                if (!a10.isAccessible()) {
                    try {
                ...
                this.f11644g = new SoftReference<>(t1Var2);
                return t1Var2;
    ...
    public final java.util.Map<java.lang.String, java.lang.Object> a(java.lang.Class<?> r11, java.lang.String[] r12) {
        ...
        L_0x009a:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.r1.a(java.lang.Class, java.lang.String[]):java.util.Map");
    }
}
