...
public class de {
    ...
    public static WindowManager f10305a;

    /* renamed from: b  reason: collision with root package name */
    public static String[] f10306b = {"x", "y", "width", "height"};

    /* renamed from: c  reason: collision with root package name */
    public static float f10307c = Resources.getSystem().getDisplayMetrics().density;

    public static float a(int i10) {
        return ((float) i10) / f10307c;
    }
    ...
    public static JSONObject a(int i10, int i11, int i12, int i13) {
        ...
        try {
            ...
            je.a("Error with creating viewStateObject", e10);
        }
        return jSONObject;
    }
    ...
    public static boolean c(org.json.JSONObject r10, org.json.JSONObject r11) {
        ...
        L_0x008f:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.de.c(org.json.JSONObject, org.json.JSONObject):boolean");
    }
    ...
    public static void a(JSONObject jSONObject) {
        ...
        if (f10305a != null) {
            ...
            f10305a.getDefaultDisplay().getRealSize(point);
            float a10 = a(point.x);
            f11 = a(point.y);
            f10 = a10;
        } else {
        ...
        try {
            jSONObject.put("width", (double) f10);
            jSONObject.put("height", (double) f11);
        } catch (JSONException e10) {
            e10.printStackTrace();
        }
    }
