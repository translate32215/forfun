...
public class c {
    ...
    public static final List<String> f12075i = Arrays.asList(new String[]{"video/mp4", "video/3gpp"});
    ...
    public VASTErrorCodes f12079d;

    /* renamed from: e  reason: collision with root package name */
    public int f12080e;

    /* renamed from: f  reason: collision with root package name */
    public int f12081f = 10;

    /* renamed from: g  reason: collision with root package name */
    public final Set<a> f12082g = new HashSet();
    ...
    public c(DisplayMetrics displayMetrics, String str) {
        ...
        float f11 = (float) i10;
        this.f12077b = f11 / ((float) i11);
        this.f12076a = (int) (f11 / f10);
        this.f12083h = str;
    }

    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r16v6, resolved type: java.lang.Object} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r9v4, resolved type: com.startapp.bc} */
    ...
    public final com.startapp.yb a(java.lang.String r21, java.util.List<java.lang.String> r22, com.startapp.sdk.ads.video.vast.c.b r23) {
        /*
            ...
            org.json.JSONArray r4 = r4.f12071c
            r4.put(r1)
        L_0x0014:
            r4 = 0
            com.startapp.bc r5 = new com.startapp.bc     // Catch:{ Exception -> 0x033c }
            r5.<init>((java.lang.String) r1)     // Catch:{ Exception -> 0x033c }
            boolean r1 = r5.f10210b
        ...
        L_0x005a:
            ...
            com.startapp.bc r5 = (com.startapp.bc) r5
        ...
        L_0x0081:
            ...
            com.startapp.bc r7 = r5.b(r7, r4, r4)
        ...
        L_0x0095:
            ...
            com.startapp.bc r13 = (com.startapp.bc) r13
        ...
        L_0x00b2:
            ...
            r9 = r16
            com.startapp.bc r9 = (com.startapp.bc) r9
            r16 = r1
            java.lang.String r1 = "type"
            java.lang.String r1 = r9.a(r1)
            java.lang.String r18 = r9.d()
            r19 = r12
            java.util.List<java.lang.String> r12 = f12075i
        ...
        L_0x01c8:
            ...
            goto L_0x021e
        L_0x01d7:
            com.startapp.yb r1 = new com.startapp.yb
            r1.<init>()
            java.util.List r3 = r7.c(r8)
            java.util.List<java.lang.String> r9 = r1.f12884b
            r9.addAll(r3)
            r0.a((com.startapp.bc) r13, (com.startapp.yb) r1)
            ...
            r1.f12900r = r3
            java.util.Set<com.startapp.sdk.ads.video.vast.a> r3 = r0.f12082g
            java.util.List r4 = r7.a()
            java.util.Set r4 = r0.a((java.util.List<com.startapp.bc>) r4)
            r3.addAll(r4)
            java.util.List r3 = r7.c(r6)
            r2.addAll(r3)
            java.util.List<java.lang.String> r3 = r1.f12883a
            r3.addAll(r2)
            goto L_0x0230
        L_0x021e:
            r3 = r23
        ...
        L_0x0230:
            ...
            java.util.List r2 = a((com.startapp.bc) r7)
            java.util.List<com.startapp.sdk.omsdk.VerificationDetails> r3 = r1.f12902t
            r3.addAll(r2)
            return r1
        L_0x023c:
            r16 = r1
        L_0x023e:
            ...
            r3 = 0
            com.startapp.bc r1 = r5.b(r1, r3, r3)
        ...
        L_0x027e:
            r5 = r23
            com.startapp.yb r3 = r0.a(r4, r3, r5)
            if (r3 != 0) goto L_0x0289
            r3 = r5
            goto L_0x0335
        L_0x0289:
            java.util.List r2 = r1.c(r8)
            java.util.List<java.lang.String> r4 = r3.f12884b
            r4.addAll(r2)
        ...
        L_0x029c:
            ...
            com.startapp.bc r4 = (com.startapp.bc) r4
            r0.a((com.startapp.bc) r4, (com.startapp.yb) r3)
            goto L_0x029c
        L_0x02ac:
            java.util.Set<com.startapp.sdk.ads.video.vast.a> r2 = r0.f12082g
        ...
        L_0x02de:
            ...
            com.startapp.bc r6 = (com.startapp.bc) r6
        ...
        L_0x0312:
            ...
            java.util.List<java.lang.String> r8 = r4.f12067e
            r8.addAll(r7)
            java.util.List r6 = r6.b()
            java.util.List<java.lang.String> r7 = r4.f12068f
            r7.addAll(r6)
            goto L_0x02de
        L_0x0329:
            java.util.List r1 = a((com.startapp.bc) r1)
            java.util.List<com.startapp.sdk.omsdk.VerificationDetails> r2 = r3.f12902t
            r2.addAll(r1)
            return r3
        L_0x0333:
            r3 = r23
    ...
    public final java.lang.String a(java.lang.String r4) throws java.io.IOException {
        /*
            ...
            int r0 = r0 + 1
            r3.f12080e = r0
            java.lang.String r0 = r3.f12083h     // Catch:{ all -> 0x0036 }
            java.net.HttpURLConnection r4 = com.startapp.d9.a(r4, r0)     // Catch:{ all -> 0x0036 }
            ...
            com.startapp.wb.a((java.io.Closeable) r0)
            r4.disconnect()
            return r1
        L_0x0030:
            r1 = move-exception
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v20, resolved type: com.startapp.zb} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v21, resolved type: com.startapp.zb} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v22, resolved type: com.startapp.zb} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r18v0, resolved type: java.lang.Integer} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v24, resolved type: com.startapp.zb} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v26, resolved type: com.startapp.zb} */
    /* JADX WARNING: type inference failed for: r3v25, types: [java.lang.Integer] */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void a(com.startapp.bc r24, com.startapp.yb r25) {
        /*
            r23 = this;
            r0 = r24
            r1 = r25
        ...
        L_0x0018:
            ...
            com.startapp.cc r6 = new com.startapp.cc
        ...
        L_0x0061:
            ...
            boolean r8 = com.startapp.cc.a(r7)
            if (r8 == 0) goto L_0x0048
            java.lang.String r6 = r6.d()
            java.lang.Integer r7 = com.startapp.cc.b(r7)
            if (r7 == 0) goto L_0x0048
            int r8 = r7.intValue()
            if (r8 < 0) goto L_0x0048
            boolean r8 = android.text.TextUtils.isEmpty(r6)
            if (r8 != 0) goto L_0x0048
            com.startapp.cc r8 = new com.startapp.cc
            r8.<init>(r6, r7)
            r2.add(r8)
            goto L_0x0048
        L_0x008a:
        ...
        L_0x0096:
            ...
            goto L_0x0096
        L_0x00b9:
            java.util.List<com.startapp.cc<java.lang.Integer>> r4 = r1.f12885c
            r4.addAll(r2)
            java.util.List<com.startapp.cc<java.lang.Integer>> r2 = r1.f12885c
        ...
        L_0x017c:
            ...
            java.util.regex.Pattern r8 = com.startapp.cc.f10252d
            ...
            if (r8 != 0) goto L_0x0165
            com.startapp.cc r8 = new com.startapp.cc     // Catch:{ NumberFormatException -> 0x01b7 }
        ...
        L_0x01b7:
            goto L_0x0165
        L_0x01b9:
            java.util.List<com.startapp.cc<java.lang.Float>> r3 = r1.f12886d
            r3.addAll(r2)
            java.util.List<com.startapp.cc<java.lang.Float>> r2 = r1.f12886d
            java.util.Collections.sort(r2)
            java.lang.String r2 = "pause"
            java.util.List r2 = r0.e(r2)
            java.util.List<java.lang.String> r3 = r1.f12887e
            r3.addAll(r2)
            java.lang.String r2 = "resume"
            java.util.List r2 = r0.e(r2)
            java.util.List<java.lang.String> r3 = r1.f12888f
            r3.addAll(r2)
            java.lang.String r2 = "complete"
            java.util.List r2 = r0.e(r2)
            java.util.List<java.lang.String> r3 = r1.f12889g
            r3.addAll(r2)
            ...
            java.util.ArrayList r4 = (java.util.ArrayList) r4
            r4.addAll(r3)
            java.util.List<java.lang.String> r3 = r1.f12890h
            r3.addAll(r2)
            java.lang.String r2 = "skip"
            java.util.List r2 = r0.e(r2)
            java.util.List<java.lang.String> r3 = r1.f12893k
            r3.addAll(r2)
            java.lang.String r2 = "ClickTracking"
            java.lang.String r3 = "VideoClicks"
            java.util.List r2 = r0.b(r2, r3)
            java.util.List<java.lang.String> r3 = r1.f12894l
            r3.addAll(r2)
            java.lang.String r2 = "mute"
            java.util.List r2 = r0.e(r2)
            java.util.List<java.lang.String> r3 = r1.f12891i
            r3.addAll(r2)
            java.lang.String r2 = "unmute"
            java.util.List r2 = r0.e(r2)
            java.util.List<java.lang.String> r3 = r1.f12892j
            r3.addAll(r2)
            java.lang.Integer r2 = r1.f12895m
            r3 = 0
        ...
        L_0x0237:
            ...
            goto L_0x0255
        L_0x0242:
            boolean r4 = com.startapp.cc.a(r2)
            if (r4 == 0) goto L_0x0255
            java.lang.Integer r2 = com.startapp.cc.b(r2)
        ...
        L_0x02c7:
            ...
            goto L_0x027e
        L_0x02d6:
            com.startapp.zb r0 = new com.startapp.zb
        ...
        L_0x02f5:
            ...
            java.lang.Integer r3 = com.startapp.cc.b(r2)
        L_0x0307:
            r18 = r3
        ...
        L_0x0329:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.sdk.ads.video.vast.c.a(com.startapp.bc, com.startapp.yb):void");
    }

    public final void a(List<String> list, VASTErrorCodes vASTErrorCodes) {
        this.f12079d = vASTErrorCodes;
    ...
    public final Set<a> a(List<bc> list) {
    ...
    public static List<VerificationDetails> a(bc bcVar) {
        ...
        String f11;
        String str;
        List<bc> a10 = bcVar.a("Verification", "AdVerifications", (String) null, (List<String>) null);
        Iterator it = ((ArrayList) bcVar.a("Extension", "Extensions", "type", Collections.singletonList("AdVerifications"))).iterator();
        while (it.hasNext()) {
            ((ArrayList) a10).addAll(((bc) it.next()).a("Verification", "AdVerifications", (String) null, (List<String>) null));
        }
        ...
        while (it2.hasNext()) {
            ...
            if (!(a11 == null || (f10 = bcVar2.f("JavaScriptResource")) == null || (f11 = bcVar2.f("VerificationParameters")) == null)) {
                bc b10 = bcVar2.b("JavaScriptResource", "apiFramework", (List<String>) null);
                if (b10 == null) {
                    str = null;
                } else {
