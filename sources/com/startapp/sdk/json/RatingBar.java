...
public class RatingBar extends LinearLayout {
    ...
    public static Map<String, String> f12583a = new HashMap<String, String>() {
        {
    ...
    public final void a(String str) {
        try {
            int a10 = qb.a(getContext(), 2);
            int a11 = qb.a(getContext(), 5);
            ImageView imageView = new ImageView(getContext());
            Bitmap a12 = e1.a(getContext(), str);
            if (a12 == null) {
                a12 = g1.a((String) ((HashMap) f12583a).get(str));
            }
            imageView.setImageBitmap(Bitmap.createScaledBitmap(a12, qb.a(getContext(), 15), qb.a(getContext(), 15), true));
