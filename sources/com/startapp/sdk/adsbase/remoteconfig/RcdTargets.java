...
public class RcdTargets implements Serializable {
    ...
    @Keep
    /* compiled from: Sta */
    public static class Parser implements pb<RcdTargets> {
            ...
            if (jSONObject != null) {
                ...
                while (keys.hasNext()) {
                    ...
                    if (next.equals("~")) {
                        ...
                        parseRec(str, f.a(str2, next), jSONObject.optJSONObject(next), sortedMap, sortedMap2);
                    } else if (next.length() > 0) {
                        add(str, f.a(str2, next), jSONObject.optInt(next), sortedMap, sortedMap2);
                    }
                }
            }
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!wb.a(this.nameToScopesIds, rcdTargets.nameToScopesIds) || !wb.a(this.scopeToNamesIds, rcdTargets.scopeToNamesIds)) {
            return false;
        }
        return true;
    }
