...
public class f0 {
    public static List<AdDetails> a(Context context, List<AdDetails> list, int i10, Set<String> set, boolean z10) {
        ...
        for (AdDetails next : list) {
            ArrayList arrayList5 = (ArrayList) wb.a((List<String>) Arrays.asList(next.w()));
            ...
            boolean z13 = AdsCommonMetaData.f12098h.H() && ((a10 && !z12) || (!a10 && z12));
    ...
    public static List<AppPresenceDetails> a(String str, int i10) {
        ...
        String a10 = wb.a(str, "@tracking@", "@tracking@");
        if (a10 != null) {
            strArr = a10.split(",");
        }
        String[] strArr2 = new String[0];
        String a11 = wb.a(str, "@appPresencePackage@", "@appPresencePackage@");
        if (a11 != null) {
            strArr2 = a11.split(",");
        }
        String[] strArr3 = new String[0];
        String a12 = wb.a(str, "@minAppVersion@", "@minAppVersion@");
        if (a12 != null) {
            strArr3 = a12.split(",");
        }
        int i11 = 0;
