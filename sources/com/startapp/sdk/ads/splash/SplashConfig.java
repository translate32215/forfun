...
public class SplashConfig implements Serializable {
    ...
    public static final Theme f11880c = Theme.OCEAN;

    /* renamed from: d  reason: collision with root package name */
    public static final MinSplashTime f11881d = MinSplashTime.REGULAR;

    /* renamed from: e  reason: collision with root package name */
    public static final long f11882e = 7500;

    /* renamed from: f  reason: collision with root package name */
    public static final MaxAdDisplayTime f11883f = MaxAdDisplayTime.FOR_EVER;

    /* renamed from: g  reason: collision with root package name */
    public static final Orientation f11884g = Orientation.AUTO;
    private static final long serialVersionUID = 995423687458599030L;

    /* renamed from: a  reason: collision with root package name */
    public transient Drawable f11885a = null;
    private String appName = "";

    /* renamed from: b  reason: collision with root package name */
    public transient String f11886b = "";
    private int customScreen = -1;
    @ob(type = MaxAdDisplayTime.class)
    private MaxAdDisplayTime defaultMaxAdDisplayTime = f11883f;
    private Long defaultMaxLoadTime = Long.valueOf(f11882e);
    @ob(type = MinSplashTime.class)
    private MinSplashTime defaultMinSplashTime = f11881d;
    @ob(type = Orientation.class)
    private Orientation defaultOrientation = f11884g;
    @ob(type = Theme.class)
    private Theme defaultTheme = f11880c;
    ...
    public static SplashConfig getDefaultSplashConfig() {
        ...
        SplashConfig minSplashTime = splashConfig.setTheme(f11880c).setMinSplashTime(f11881d);
        minSplashTime.defaultMaxLoadTime = Long.valueOf(f11882e);
        minSplashTime.setMaxAdDisplayTime(f11883f).setOrientation(f11884g).setLoadingType("LoadingDots").setAppName("");
        return splashConfig;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.forceNative == splashConfig.forceNative && this.customScreen == splashConfig.customScreen && this.logoRes == splashConfig.logoRes && this.htmlSplash == splashConfig.htmlSplash && wb.a(this.appName, splashConfig.appName) && Arrays.equals(this.logoByteArray, splashConfig.logoByteArray) && this.defaultTheme == splashConfig.defaultTheme && this.defaultMinSplashTime == splashConfig.defaultMinSplashTime && wb.a(this.defaultMaxLoadTime, splashConfig.defaultMaxLoadTime) && this.defaultMaxAdDisplayTime == splashConfig.defaultMaxAdDisplayTime && this.defaultOrientation == splashConfig.defaultOrientation && wb.a(this.splashBgColor, splashConfig.splashBgColor) && wb.a(this.splashFontColor, splashConfig.splashFontColor) && wb.a(this.splashLoadingType, splashConfig.splashLoadingType)) {
            return true;
        }
        return false;
    }
    ...
    public void setDefaults(Context context) {
        ...
        SplashConfig a10 = SplashMetaData.f11907a.a();
        if (a10 == null) {
    ...
    public View a(Context context) {
        ...
        if (theme == Theme.USER_DEFINED) {
            ...
            switch (g.a.f11936a[theme.ordinal()]) {
                case 1:
    ...
    public boolean b(Context context) {
        if (AnonymousClass1.$SwitchMap$com$startapp$sdk$ads$splash$SplashConfig$Theme[this.defaultTheme.ordinal()] != 7) {
            ...
            if (getLogo() == null && getLogoByteArray() == null) {
                try {
                    if (getLogoRes() == -1) {
                        ...
                        this.f11885a = context.getResources().getDrawable(context.getApplicationInfo().icon);
                    } else {
                        this.f11885a = context.getResources().getDrawable(getLogoRes());
                    }
                } catch (Throwable th) {
                    i4.a(th);
                }
            ...
            this.f11886b = "StartApp: Exception getting custom screen resource id, make sure it is set";
            return false;
        }
        return true;
    }
