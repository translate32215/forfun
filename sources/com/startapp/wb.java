...
public class wb {
    ...
    public static Map<Activity, Integer> f12765a = new WeakHashMap();

    /* renamed from: b  reason: collision with root package name */
    public static volatile Intent f12766b;

    /* renamed from: c  reason: collision with root package name */
    public static volatile Boolean f12767c;
    ...
    public static String a(Drawable drawable, int i10, int i11, Bitmap.Config config) {
        ...
        y2 y2Var = new y2(i10 * i11);
        createBitmap.compress(Bitmap.CompressFormat.PNG, 100, y2Var);
        return new String(Base64.encode(y2Var.a(), 0, y2Var.b(), 2));
    }
    ...
    public static String c(String str) throws IOException {
        return Base64.encodeToString(a.a(a(str)), 10);
    }
    ...
    public static android.content.Intent a(android.content.Context r8, java.lang.String r9) {
        ...
        L_0x0010:
            ...
            android.content.Intent r2 = f12766b
            if (r2 == 0) goto L_0x0020
        ...
        L_0x0033:
            ...
            com.startapp.vb r7 = new com.startapp.vb     // Catch:{ all -> 0x004a }
        ...
        L_0x005f:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.wb.a(android.content.Context, java.lang.String):android.content.Intent");
    }
    ...
    public static boolean d(String str) {
        ...
        try {
            String[] split = new URL(MetaData.f12393k.c()).getHost().split("\\.");
            if (split.length > 1) {
    ...
    public static java.lang.String b(java.lang.Throwable r7) {
        ...
        L_0x002e:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.wb.b(java.lang.Throwable):java.lang.String");
    }
    ...
    public static int a(Activity activity, int i10, boolean z10) {
        if (z10) {
            if (!((WeakHashMap) f12765a).containsKey(activity)) {
                ((WeakHashMap) f12765a).put(activity, Integer.valueOf(activity.getRequestedOrientation()));
            }
        ...
        int i11 = -1;
        if (((WeakHashMap) f12765a).containsKey(activity)) {
            i11 = ((Integer) ((WeakHashMap) f12765a).get(activity)).intValue();
            int i12 = a0.f10005a;
            try {
                activity.setRequestedOrientation(i11);
            } catch (Throwable unused) {
            }
            ((WeakHashMap) f12765a).remove(activity);
        }
        return i11;
    }
    ...
    public static boolean a(WebView webView, String str) {
        try {
            webView.loadDataWithBaseURL(MetaData.f12393k.o(), str, "text/html", XML.CHARSET_UTF8, (String) null);
            return true;
        } catch (Throwable th) {
            i4.a(th);
            return false;
    ...
    public static void a(Context context, int i10, String str, boolean z10) {
        ...
        if (z10) {
            if (f(context) || a0.c(context)) {
                ...
                i4Var.f10537d = "Log for a publisher";
                i4Var.f10538e = str;
                i4Var.a();
            }
        }
