...
public final class mk implements mi {
    ...
    public static final ThreadLocal<Cipher> f7489b = new c60();

    /* renamed from: a  reason: collision with root package name */
    public final SecretKey f7490a;

    public mk(byte[] bArr) throws GeneralSecurityException {
        hp.a(bArr.length);
        this.f7490a = new SecretKeySpec(bArr, "AES");
    }
    ...
    public final byte[] a(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        if (bArr.length <= 2147483619) {
            ...
            ThreadLocal<Cipher> threadLocal = f7489b;
            threadLocal.get().init(1, this.f7490a, algorithmParameterSpec);
